...
> Scrape Glassdoor job listings, salaries, company reviews

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/glassdoor-scraper?style=flat-square)](https://github.com/data-scrape/glassdoor-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/glassdoor-scraper?style=flat-square)](https://github.com/data-scrape/glassdoor-scraper/forks)
...
**Glassdoor Scraper** is a free, open-source Python scraper for **Glassdoor**. Extract structured data from glassdoor with full pagination support, proxy rotation, and multiple export formats.

glassdoor scraper, scrape glassdoor, glassdoor reviews scraper
...
```bash
git clone https://github.com/data-scrape/glassdoor-scraper.git
...
```bash
python scraper.py "Software Engineer salaries at Google"
```
...
`job_id` | `title` | `company` | `location` | `salary_estimate` | `job_description` | `company_rating` | `ceo_approval` | `ceo_name` | `founded` | `industry` | `size` | `url`
